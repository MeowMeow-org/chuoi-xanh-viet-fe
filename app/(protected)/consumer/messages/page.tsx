...
function MessagesPageInner() {
  ...
  const messagesQuery = useQuery({
    ...
    queryFn: () =>
      chatService.listMessages(selectedId as string, { limit: 100 }),
    enabled: !!selectedId,
  ...
  const handleBack = () => {
    router.replace("/consumer/messages");
  };
                ...
                <>
                  <header className="border-b p-3 flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-sm">
                        {getPeer(selectedConversation, userId).fullName ??
                          "Người dùng"}
                      </p>
                  ...
                  >
                    ...
                    <Button
                      ...
                      size="icon"
                      disabled={
                        !composerValue.trim() || sendMutation.isPending
                      }
                    >
