      ...
      <div className="mx-auto max-w-5xl space-y-6">
        <header className="rounded-2xl border border-[hsl(142,15%,88%)] bg-white p-6 shadow-sm">
          ...
          <h1 className="mt-2 text-3xl font-extrabold tracking-tight">
            Cooperative Dashboard (placeholder)
          </h1>
          <p className="mt-3 text-sm text-[hsl(150,5%,45%)]">
            Trang tam de test navigate theo role cooperative sau khi login thanh cong.
          </p>
        </header>

        <section className="grid gap-4 md:grid-cols-3">
          <article className="rounded-xl border border-[hsl(142,15%,88%)] bg-white p-5">
            <p className="text-sm text-[hsl(150,5%,45%)]">Thanh vien</p>
            <p className="mt-2 text-2xl font-bold">24</p>
          </article>
          <article className="rounded-xl border border-[hsl(142,15%,88%)] bg-white p-5">
            <p className="text-sm text-[hsl(150,5%,45%)]">Mua vu dang theo doi</p>
