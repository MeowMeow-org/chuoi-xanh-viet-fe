...
export const FARMER_FARMS_LIST_ONBOARDING_KEY = "cxv_onboarding_farmer_farms_list_v1";
export const FARMER_FARM_CREATE_ONBOARDING_KEY = "cxv_onboarding_farmer_farm_create_v1";
